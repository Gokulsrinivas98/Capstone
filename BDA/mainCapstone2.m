...
CostFunction=@(x,u) MyCostCapstone2(x,u); % Modify or replace Mycost.m according to your cost funciton
...
[Best_pos, Best_score ,Convergence_curve]=BDACapstone2(N, Max_iteration, nVar, CostFunction);
...
AFopt  = CostFunction(m,u);           Gainopt  = 20*log10(AFopt);
AForig = CostFunction(ones(1,nVar+2),u);  Gainorig = 20*log10(AForig);
%% 
